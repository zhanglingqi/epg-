...
Epg.Log =
    {
        ...
        access: function (source, target, targetType, addAccessLog, columnIdx, pagePropSrc) {
            ...
            if (addAccessLog === '' || addAccessLog === 'true' || addAccessLog === true || addAccessLog === undefined) {
...
Epg.Mp = Epg.mp = (function () {
    return {
        ...
        init: function (defaultTip) {
            ...
            mp.setProgressBarUIFlag(1); //0：不显示自带的进度条，1：显示自带进度条，默认为显示
        ...
        fullscreenPlayOfZTE: function (url) {
            //url = url===undefined?'rtsp://125.88.104.45/88888888/16/20111122/269226549/269226549.ts':url;
